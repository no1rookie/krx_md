...
out_f = open(WDIR + '/TSDB_BATCH_ETC_' + RD_DATE + '.csv', 'w')
...
out_f.write('isin|short_code|name_korean|name_english|security_type|industry_id|listed_date|listed_qty|listed_market' + '\n')
...
out_file_name = WDIR + '/TSDB_BATCH_ETC_' + RD_DATE + '.csv'
