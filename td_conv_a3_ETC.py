...
## Working directory
WDIR = '/home/trading/server/prep-data/tsdb/a0_etc'
...
BF_NAME = WDIR + '/TSDB_BATCH_ETC_' + RD_DATE + '.csv'
...
out_f = open(WDIR + '/TSDB_TICK_ETC_' + RD_DATE + '.csv', 'w')
...
out_file_name = WDIR + '/TSDB_TICK_ETC_' + RD_DATE + '.csv'
